    ...
    <h1 >Information</h1>
      <div class="accordion " id="accordionExample">
        <div class="card">
          ...
          >
            <div class="card-body">
              ...
              <p class="indent">
                The Northside Youth Soccer League was established in 1996 to
                provide athletes residing in Chicago's northside neighborhoods
                an environment in which to learn and play soccer. To be a member
                of NYSL, you must be between the ages of 4 - 12 and reside in a
                Chicago northside neighborhood. NYSL is run by a small full-time
        ...
        <div class="card">
          ...
          >
            <div class="card-body">
              <p>Please direct all questions to our email or to Michael Randall, league coordinator.</p>
              <p>Email NYSL: <a href="mailto:nysl@chisoccer.org">nysl@chisoccer.org</a></p>
              <p>Email Michael Randall: <a href="mailto:michael.randall@chisoccer.org"> michael.randall@chisoccer.org</a></p>
