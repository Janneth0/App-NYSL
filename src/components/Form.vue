<template>
  <!-- PARTE IMPORTANTE FORMULARIO -->
  <div class="bodycontent">
    <form method="get" id="form">
      <fieldset class="boxset">
        <legend class="txt-c">Personal Information</legend>
        <label
          >Player's First Name:
        ...
        <label>
          Street Address:
          <input type="text" name="Street_Address" class="w-full" /> </label
        ><br />
        <label> City: <input type="text" name="City" /></label>
        <label> Zip Code:<input type="text" name="Zip_Code" /> </label><br />
        <label>
          Birth Date (mm/dd/yyyy): <input type="date" name="Birth_Date" />
        </label>
        <div id="gender">
          <label>Gender:</label>
          <label
        ...
        <div id="grade">
          ...
          <div class="grade-col">
            ...
            <label
              ><input type="radio" name="grade" value="1st" /> 1<sup
                >st</sup
              ></label
            >
            <label
              ><input type="radio" name="grade" value="2nd" /> 2<sup
                >nd</sup
              ></label
            >
          </div>
          <div class="grade-col">
            <label
              ><input type="radio" name="grade" value="3rd" /> 3<sup
                >rd</sup
              ></label
            >
            <label
              ><input type="radio" name="grade" value="4th" /> 4<sup
                >th</sup
              ></label
            >
            <label
              ><input type="radio" name="grade" value="5th" /> 5<sup
                >th</sup
              ></label
            >
          </div>
        ...
        <label>
          Parent/Guardian:
          <input type="text" name="Parent-Guardian" class="w-full" /> </label
        ><br />
        <label>
          Contact Phone:
